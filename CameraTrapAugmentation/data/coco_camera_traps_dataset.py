...
class CocoCameraTrapsBboxDataset:
    ...
    * :obj:`difficult.dtype == numpy.bool`
    ...
    def __init__(self, root, ann_file, max_images=None, loadBboxes=True):
        self.root = root
        self.loadBboxes = loadBboxes
    ...
    def find_files(self, str):
        indices = [i for i, x in enumerate(self.impaths) if (x.find(str) != -1)]

        return indices, self.impaths[indices].tolist()
